        ...
        <div className="w-full mt-20">
            ...
            <div className="mt-4">
                <div className="flex justify-between items-center">
                    ...
                    <input 
                        type="checkbox"
                        onChange={() => setTienePassword(!tienePassword)}    //si toco el checkbox le paso true al state. El valor que le paso tiene que ser lo contrario a lo que está en el state
                    />
                </div>
                {tienePassword 
                    ? (
                        <input 
                            type="password" 
                            className="appareance-none w-full mt-2 bg-white border border-gray-400 text-black py-3 px-4 pr-8"
